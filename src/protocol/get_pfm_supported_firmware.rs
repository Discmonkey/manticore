...
///
/// Corresponds to [`CommandType::PFMSupportedFirmware`].
pub enum GetPFMSupportedFirmware {}

impl<'a> Command<'a> for GetPFMSupportedFirmware {
    type Req = GetPFMSupportedFirmwareRequest;
    type Resp = GetPFMSupportedFirmwareResponse<'a>;
}
